...
async function fetchData() {
  try {
      const contributorsResponse = await fetch('https://api.github.com/repos/PriyaGhosal/BuddyTrail/contributors');
      const contributorsData = await contributorsResponse.json();

      const repoResponse = await fetch('https://api.github.com/repos/PriyaGhosal/BuddyTrail');
